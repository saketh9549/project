...
def run_upload_and_verify():
    ...
    print(f"Found file at path. Size: {file_size} bytes. Starting upload to cloud MongoDB Atlas...")
    ...
    print(f"Connecting to MongoDB Atlas at cloud to verify GridFS storage...")
