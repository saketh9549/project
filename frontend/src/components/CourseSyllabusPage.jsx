      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        ...
        <div className="flex flex-col gap-4">
          <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider font-display border-b border-white/5 pb-2 flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono font-bold text-blue-400 bg-blue-500/10 border border-blue-500/10 px-2.5 py-0.5 rounded-full">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between p-3.5 px-4.5 border rounded-2xl transition-all shadow-md ${
                      isUnlocked
                        ? 'bg-white/4 border-white/5 hover:bg-white/10 hover:border-white/10 hover:translate-x-0.5 active:scale-[0.998] cursor-pointer group'
                        : 'bg-white/[0.01] border-white/3 opacity-30 cursor-not-allowed select-none'
                    }`}
                    title={isUnlocked ? "" : "Locked: Score 75%+ on preceding quiz to unlock."}
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      <div className={`w-8 h-8 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center shrink-0 shadow-inner transition-all ${
                        isUnlocked ? 'text-gray-400 group-hover:text-blue-400 group-hover:bg-blue-500/10' : 'text-gray-600'
                      }`}>
                        {isUnlocked ? (
              ...
              {quizzes.map((quizItem) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      <div className={`w-8 h-8 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center shrink-0 shadow-inner transition-all ${
                        isUnlocked ? 'text-gray-400 group-hover:text-indigo-400 group-hover:bg-indigo-500/10' : 'text-gray-600'
                      }`}>
                        {isUnlocked ? (
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
